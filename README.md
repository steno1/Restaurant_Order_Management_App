...
/Restaurant_Order_Management_System
    ├── /src
    │   ├── Menu.js          # Menu class for adding/displaying items
    │   ├── Order.js         # Order class for creating and calculating orders
    │   ├── Customer.js      # Customer class for managing customer details
    │   ├── Restaurant.js    # Restaurant class for managing restaurant operations
    │   └── index.js         # Main entry point to run the app
